    ...
    def _load_sample(self, image_path=None, label_path=None, never_aug=False):
        ...
        if image_path:
            ...
            if self.options['input_channels'] == 4:
                ...
                # print(image.shape, extra_channel.shape, image.dtype, extra_channel.dtype)
...
# if __name__ == '__main__':
#
#     # Get the subfolders in the the stage2_test folder
#     _test_IDs = next(os.walk(_DSB18_DATASET + '/stage2_test_final'))[1]
#     _test_IDs_file = _DSB18_DATASET + '/test.txt'
#
#     # Save test ID file
#     with open(_test_IDs_file, 'w') as f:
#         for ID in _test_IDs:
#             f.write('{}\n'.format(str(ID)))
#
